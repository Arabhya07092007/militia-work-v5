class Players{
    constructor(){
        ...
        this.kills = 0;
        this.mousy = null;
        this.positions = {x:0,y:2000};
        this.velocities = null;
        this.name = null;

        this.body = new Man(2070,300,45,180);
       ...
       /// Matter.Body.setPosition(this.body,{x:0,y:2000});
       // Matter.Body.setPosition(this.body,{x:0,y:2000});
    ...
    mummy(){
        ...
        Matter.Body.setVelocity(this.body,{x: -0.10012674247977366, y: -1.1944740115317418});
